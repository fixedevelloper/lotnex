        ...
        <header
            ...
            <nav class="z-10 w-full max-w-desktop-preview-bar m-auto header-border-b">
                <div class="flex items-center justify-between"><a href="/">
                        <img class="hidden lg:block" width="45" height="30"  src="{{asset("lmodel/icon_nexa.png")}}">
                        <img class="block lg:hidden" width="103" height="30"  src="{{asset("lmodel/icon_nexa.png")}}">
