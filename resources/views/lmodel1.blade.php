                ...
                <div class="flex w-full overflow-hidden items-center justify-between space-x-2.5 lg:items-start ">
                    <div
                        class="w-full flex justify-start items-center space-x-5 lg:flex-col lg:h-full lg:items-start lg:space-x-0 lg:space-y-7.5">
                            ...
                            <div class="flex items-center  false lg:w-full lg:pr-10 sm:pr-5" >
                            <a href="/">
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="flex items-center  lg:flex-col lg:items-start lg:w-full lg:pr-10 sm:pr-5"><a href="/">
                            ...
                            @if(!$isLogged)
                            <span class="text-base text-white whitespace-nowrap mr-5 notranslate lg:mr-0 lg:text-2xl lg:text-medium lg:mb-7.5">Preview ID<span
                                    class="hidden lg:inline ml-1.5">{{$id}}</span></span>
                            <div class="flex justify-between items-center space-x-2.5 lg:space-x-5 lg:w-full lg:flex">
                                <form>
                                    <input name="id"
                            ...
                            <div class="grid w-full gap-10 mt-8 grid-cols-2 sm:grid-cols-1">
                             ...
                             {{--   <a class="cursor-not-allowed relative flex flex-col p-7.5 w-full bg-gray rounded z-10 overflow-hidden justify-between min-h-programDashboard sm:p-5 sm:min-h-programDashboardMobile"
                                    ...
                                    <div class="flex justify-between w-full z-10">
                                        ...
                                        <span
                                            class="text-white text-2xl font-bold justify-end text-right notranslate sm:text-xl">0 BUSD</span>
                                    </div>
                                    <div class="flex justify-between h-full w-full">
                                        <div class="flex justify-between w-full z-10 sm:flex-col mt-5 w-full items-end">
                                            <div
                                            ...
                                            <div class="flex items-center sm:items-start justify-start sm:w-full">
                                                ...
                                                <div class="flex ml-5 items-center sm:w-full flex-wrap sm:ml-2.5">
                                                    <a
                                                        ...
                                                        href="/dashboard?id=1644320">ID 1644320</a>
                                                    <div
