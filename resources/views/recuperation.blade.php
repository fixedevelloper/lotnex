...
<head>
    ...
    <title>Recuperation | NEXACHAIN FDUSD</title>
                            ...
                            <div class="flex flex-col flex-wrap w-full sm:px-5">
                                ...
                                <div class="flex items-center mb-1.5 sm:mb-2.5">
                                    <div class="flex"><a class="mr-1.5 text text-white-300 sm:text-sm"
                                            ...
                                            /</a></div>
                                    <span class="text text-white whitespace-nowrap sm:text-sm">Nexachain </span><span
                                        class="text text-white whitespace-nowrap ml-1.5 sm:text-sm"></span></div>
                                <div class="w-full flex justify-between flex-wrap">
                                    <div class="flex flex-wrap items-center"><span
                                            class="text-two-half text-white font-medium mr-2 sm:text-2xl sm:max-w-[170px]">Nexachain A</span>
                                    </div>
                            ...
                            <div
                                ...
                                <div class="flex flex-col mb-10 sm:mb-7.5">
                                    <div class="w-full relative flex flex-col flex-grow-0 flex-shrink-0">
                                        ...
                                        <div class="w-full relative">
                                            <input id="new_address_recup"  class="w-full bg-white-100 border-2 border-transparent
                                ...
                                <div class="flex flex-col items-start sm:items-center space-y-2.5">
                                    <div class="flex space-x-2.5 sm:w-full">
                                        <button onclick="subcription.recuperation()"
                                            ...
                                            Save User <i id="spinner_loader" class="loader"></i>
                                        </button>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    var configs={
        routes:{
            ...
            recuperation_ajax: "{{\Illuminate\Support\Facades\URL::route('recuperation_ajax')}}",
        }
    }
    $('#hambuger').hide()
    function showMenu() {
